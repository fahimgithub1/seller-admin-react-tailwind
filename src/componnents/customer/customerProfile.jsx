...
export default function Customerprofile(){
    ...
    return(
        <DivWrepper>
            <div className="text-center pb-3 mb-4 border-b-[1px] border-gray-500">
                <img src={customer} alt="customer" className="m-auto rounded-full h-[150px] w-40 mb-3" />
                <BlueSpan 
                            text="jessica-moore@example.com"
                />

                <Paragrap
                            text='+38 (094) 730-24-25'
                            styles='mb-0'
                />
            </div>
